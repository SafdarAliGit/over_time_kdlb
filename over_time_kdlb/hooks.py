app_name = "over_time_kdlb"
app_title = "Over Time Kdlb"
...
doc_events = {
    "Timesheet": {
        "before_submit": "over_time_kdlb.events.add_up_over_time.submit",
        "on_cancel": "over_time_kdlb.events.add_up_over_time.cancel",
    }
